...
const Header = () => {
  ...
  return (
      <header className="fixed inset-x-0 top-0 z-50 bg-gradient-to-b from-elevation md:to-transparent fadeinslow">

        <nav className="relative flex items-center justify-between p-4 lg:px-8" aria-label="Global">
            {/* Logo: */}
            <div className="flex lg:flex-1">
                <a href="/" className="transition-all ease-in-out duration-200 text-txt hover:text-bright hover:-translate-y-1">
            ...
            <div className="transition-all ease-in-out duration-200 text-sm font-semibold leading-6 text-txt hover:text-bright paragraph rounded-lg px-3 ring-1 ring-txt">
                    <p>Resume</p>
                </div>
            </div>
        </nav>
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
            ...
            <div className="mt-6 flow-root">
                ...
                <div className="transition-color ease-in-out duration-200 ring-1 ring-txt hover:bg-elevation block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-txt hover:bg-elevation hover:text-bright paragraph">
                    <p>Resume</p>
                </div>
